<?php
  ...
  if(isset($_GET['GetStaff'])){
    ...
    ON user_table.user_id = staff_table.staff_id WHERE user_table.user_access = 'DOCTOR' ORDER BY user_table.user_id DESC");
  ...
  else if(isset($_GET['GetSpecificStaff']))
  {
    ...
    WHERE user_table.user_access = 'DOCTOR' AND user_table.user_id = '$ID'")));
  }